    ...
    <div className="mx-auto grid max-w-7xl grid-cols-1 gap-3 p-4 md:grid-cols-3">
      {items.map((item, index) => (
        <div
          key={index}
          className={cn(
            "group relative overflow-hidden rounded-xl border border-gray-100/80 bg-white p-4 transition-all duration-300 will-change-transform dark:border-white/10 dark:bg-black",
